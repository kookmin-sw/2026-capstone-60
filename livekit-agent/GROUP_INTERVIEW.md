...
- 그 외는 마이크 송출 OFF, 다른 참가자 **원격 오디오 트랙 구독**은 유지
- 면접 중 실제로 들리는 목소리는 **AI 면접관 TTS + 현재 답변자 1명**으로 제한
- 비활성 참가자는 답변자 목소리와 AI 면접관 질문을 듣지만, 본인 마이크 트랙은 publish 하지 않음
...
- [ ] INTEGRATION_CONTRACT §11.8 체크리스트 전항목 :white_check_mark:
