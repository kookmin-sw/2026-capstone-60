  ...
  return (
    <div className="fixed inset-0 w-screen h-screen bg-slate-100 flex flex-col overflow-hidden z-40">
      ...
      <motion.header
        ...
        className="relative flex items-center justify-between px-5 py-3 bg-white/65 backdrop-blur-2xl backdrop-saturate-150 border-b border-white/80 z-10"
      >
      ...
      <div className="flex-1 flex relative z-10 min-h-0">
        ...
        <div className="flex-1 flex items-stretch p-4 pb-32 min-w-0">
          ...
          >
            <div className="w-full bg-white/65 backdrop-blur-2xl backdrop-saturate-150 rounded-2xl shadow-2xl shadow-blue-900/15 border border-white/80 overflow-hidden flex">
        ...
        <motion.aside
          ...
          className="w-[300px] bg-white/65 backdrop-blur-2xl backdrop-saturate-150 border-l border-white/80 flex flex-col"
        >
      ...
      >
        <div className="flex items-center justify-center gap-4 px-6 py-4 bg-white/65 backdrop-blur-2xl backdrop-saturate-150 border border-white/80 rounded-2xl shadow-2xl shadow-blue-900/15">
          {/* Mic Toggle */}
          <div className="relative">
            {isMicOn && (
              <>
